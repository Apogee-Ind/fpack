...
tellraw @s [{"text": "Sector ", "color": "dark_aqua"},{"score":{"name": "@s","objective": "boat.sector_counter"}, "color": "dark_aqua"},{"text": ": ","color": "dark_aqua"},{"score":{"name": "@s", "objective": "boat.t_minutes"}},{"text": "m "},{"score":{"name": "@s","objective": "boat.t_seconds"}},{"text": "s "},{"score":{"name": "@s","objective": "boat.t_ms"}}]