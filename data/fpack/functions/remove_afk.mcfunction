...
execute unless score @s afk.x1 = @s afk.x0 run team join afk.active_team @s
execute unless score @s afk.y1 = @s afk.y0 run team join afk.active_team @s
execute unless score @s afk.z1 = @s afk.z0 run team join afk.active_team @s
execute as @s[team=!afk.afk_team] run tellraw @a [{"text": "","color": "green","extra":[{"selector":"@s"}]},{"text": " is no longer AFK.", "color": "white"}]
