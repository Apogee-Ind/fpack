...
execute in fpack:end_2 positioned 0 60 0 as @n[type=minecraft:end_crystal,limit=4] run data merge entity @s {BeamTarget:{"X":0, "Y":128, "Z":0}}
...
scoreboard players set EndPillarCounter afk.counter 0
