...
execute in fpack:end_2 positioned 0 60 0 at @e[type=minecraft:end_crystal, limit=10, distance=5..96] run summon end_crystal
execute in fpack:end_2 as @e[type=minecraft:end_crystal,nbt={beam_target:[I;0,128,0]}, distance=5..96] run kill @s
